...
This codebase was created to demonstrate a fully fledged backend api built with golang (echo) including CRUD operations, authentication, routing, pagination, and more.
